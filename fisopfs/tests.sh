...
prueba_crear_enlace_simbolico () {
    echo -e "\n===================================="
    echo "PRUEBA Creacion de enlaces simbolicos"
    touch archivesco
    echo "> Se crea un archivo"
    ln -s archivesco link-s-archivesco
    echo -e "> Se crea un enlace simbolico" 
    ls
    echo -e "> Se deberia ver el enlace simbolico.\n"
}

prueba_si_escribo_en_un_enlace_simbolico_se_escribe_en_el_archivo () {
    echo -e "\n===================================="
    echo "PRUEBA escritura de archivos desde enlaces simbolicos"
    echo "texto escrito en enlace simbolico" > link-s-archivesco
    cat link-s-archivesco
    echo "> Se muestra el texto del enlace simbolico"
    cat archivesco 
    echo -e "> Se imprime el contenido del archivo. Deveria ser el mismo que escrito en el enlace simbolico\n"
}

prueba_si_agrego_texto_en_un_archivo_agrego_tambien_a_un_enlace_simbolico () {
    echo -e "\n===================================="
    echo "PRUEBA escritura de enlace simbolico desde archivo"
    echo "texto escrito en archivo" >> archivesco
    cat archivesco
    echo "> Se muestra el texto del archivo"
    cat link-s-archivesco
    echo -e "> Se imprime el contenido del enlace simbolico. Deveria ser el mismo que escrito en el archivo\n"
}

prueba_se_pueden_elimnar_enlaces_simbolicos () {
    echo -e "\n===================================="
    echo "PRUEBA eliminar enlaces simbolicos"
    ls 
    echo "> Se muestra que hay un enlace simbolico"
    rm  link-s-archivesco
    ls 
    echo -e "> No se deberia ver el enlace simbolico\n"
    rm archivesco 
}
